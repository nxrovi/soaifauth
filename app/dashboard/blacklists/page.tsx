...
import { BlacklistsContent } from '@/components/dashboard/BlacklistsContent'
...
export default async function BlacklistsPage() {
  ...
  // TODO: Fetch blacklists from database when Blacklist model is added
  ...
  return (
    <div className="min-h-screen relative z-10" suppressHydrationWarning>
      ...
      <BlacklistsContent user={user} apps={apps} blacklists={blacklists} currentAppId={selectedAppId} />
    </div>
  )
}
