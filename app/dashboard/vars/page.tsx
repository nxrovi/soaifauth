...
import { VarsContent } from '@/components/dashboard/VarsContent'
import { prisma } from '@/lib/prisma'

export default async function VarsPage() {
  ...
  // TODO: Fetch global variables from database when Variable model is added
  ...
  return (
    <div className="min-h-screen relative z-10" suppressHydrationWarning>
      ...
      <VarsContent user={user} apps={apps} variables={variables} currentAppId={selectedAppId} />
    </div>
  )
}
