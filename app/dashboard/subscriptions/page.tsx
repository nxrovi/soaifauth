...
export default async function SubscriptionsPage() {
  ...
  // TODO: Fetch subscriptions from database when Subscription model is added
  ...
  return (
    <div className="min-h-screen relative z-10" suppressHydrationWarning>
      ...
      <SubscriptionsContent user={user} apps={apps} subscriptions={subscriptions} currentAppId={selectedAppId} />
    </div>
  )
}
